...
set(MYLITE_MARIADB_HAS_INNOBASE ON)
...
if(EXISTS "${MYLITE_MARIADB_BUILD_DIR}/CMakeCache.txt")
  ...
  file(STRINGS
    "${MYLITE_MARIADB_BUILD_DIR}/CMakeCache.txt"
    mylite_mariadb_innobase_cache
    REGEX "^PLUGIN_INNOBASE:.*=(NO|OFF|FALSE|0)$"
  )
  if(mylite_mariadb_innobase_cache)
    set(MYLITE_MARIADB_HAS_INNOBASE OFF)
  endif()
...
function(mylite_add_mariadb_embedded_target)
  ...
  set(mariadb_tpool_archive "${MYLITE_MARIADB_BUILD_DIR}/tpool/libtpool.a")
  ...
  if(NOT TARGET MyLite::MariaDBEmbedded)
    ...
    if(EXISTS "${mariadb_tpool_archive}")
      target_link_libraries(mylite_mariadb_embedded INTERFACE "${mariadb_tpool_archive}")
    endif()
    if(MYLITE_MARIADB_WITH_ZLIB_COMPRESSION)
...
function(mylite_link_mariadb_embedded target)
  ...
  if(MYLITE_MARIADB_HAS_INNOBASE)
    set(mylite_mariadb_has_innobase_define 1)
  else()
    set(mylite_mariadb_has_innobase_define 0)
  endif()
  ...
  target_compile_definitions("${target}" PRIVATE
    ...
    MYLITE_MARIADB_HAS_INNOBASE=${mylite_mariadb_has_innobase_define}
