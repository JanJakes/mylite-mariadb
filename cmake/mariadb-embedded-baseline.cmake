...
# MyLite routes ENGINE=InnoDB to MyLite storage and does not expose native InnoDB files.
set(PLUGIN_INNOBASE "NO" CACHE STRING "Disable native InnoDB storage engine" FORCE)
set(WITH_INNODB_AHI OFF CACHE BOOL "Disable InnoDB adaptive hash index support" FORCE)
set(WITH_INNODB_ROOT_GUESS OFF CACHE BOOL "Disable InnoDB root-guess cache support" FORCE)

# MyLite rejects partition DDL until partition metadata routes through MyLite storage.
set(PLUGIN_PARTITION "NO" CACHE STRING "Disable native partition storage engine wrapper" FORCE)
...
# MyLite rejects replication filters before MariaDB execution.
set(MYLITE_WITH_RPL_FILTER_RUNTIME OFF CACHE BOOL "Omit replication filter runtime" FORCE)

# MyLite rejects replication/binlog SQL and omits disabled topology variables.
set(MYLITE_WITH_BINLOG_SYSVARS OFF CACHE BOOL "Build binlog and replication system variables" FORCE)
...
# MyLite does not expose native CSV table files.
set(MYLITE_WITH_CSV_STORAGE_ENGINE OFF CACHE BOOL "Build native CSV storage engine" FORCE)
