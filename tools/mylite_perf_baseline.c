...
size_t mylite_storage_test_dirty_page_copy_pager_read_site_slot_count(void);
const char *mylite_storage_test_dirty_page_copy_pager_read_site_slot_name(size_t slot);
unsigned long long mylite_storage_test_dirty_page_copy_pager_read_site_family_count(
    size_t site_slot,
    size_t family_slot
);
unsigned long long mylite_storage_test_dirty_page_copy_pager_read_site_dirty_family_count(
    size_t site_slot,
    size_t family_slot
);
...
unsigned long long mylite_storage_test_dirty_page_buffer_flush_family_page_count(
    size_t source_slot,
    size_t family_slot
);
size_t mylite_storage_test_dirty_page_buffer_flush_leaf_shape_slot_count(void);
const char *mylite_storage_test_dirty_page_buffer_flush_leaf_shape_slot_name(size_t slot);
unsigned long long mylite_storage_test_dirty_page_buffer_flush_leaf_shape_count(
    size_t source_slot,
    size_t shape_slot
);
...
size_t mylite_storage_test_dirty_page_buffer_flush_leaf_free_slot_band_slot_count(void);
const char *mylite_storage_test_dirty_page_buffer_flush_leaf_free_slot_band_slot_name(size_t slot);
unsigned long long mylite_storage_test_dirty_page_buffer_flush_leaf_free_slot_band_count(
    size_t source_slot,
    size_t band_slot
);
...
unsigned long long mylite_storage_test_dirty_page_buffer_flush_leaf_page_id_rank_fill_band_count(
    size_t source_slot,
    size_t rank_slot,
    size_t band_slot
);
...
unsigned long long mylite_storage_test_dirty_page_buffer_flush_write_site_dirty_family_count(
    size_t site_slot,
    size_t source_slot,
    size_t family_slot
);
unsigned long long mylite_storage_test_dirty_page_buffer_pressure_incoming_family_page_count(
    size_t family_slot
);
...
size_t mylite_storage_test_dirty_page_buffer_leaf_free_slot_detail_band_slot_count(void);
const char *mylite_storage_test_dirty_page_buffer_leaf_free_slot_detail_band_slot_name(size_t slot);
...
unsigned long long mylite_storage_test_dirty_page_buffer_pressure_admission_source_dirty_family_count(
    size_t source_slot,
    size_t family_slot
);
size_t mylite_storage_test_dirty_page_buffer_pressure_admission_entry_replacement_state_slot_count(
    void
);
const char *mylite_storage_test_dirty_page_buffer_pressure_admission_entry_replacement_state_slot_name(
    size_t slot
);
unsigned long long mylite_storage_test_dirty_page_buffer_pressure_admission_entry_replacement_state_family_count(
    size_t state_slot,
    size_t family_slot
);
unsigned long long mylite_storage_test_dirty_page_buffer_pressure_admission_entry_replacement_state_dirty_family_count(
    size_t state_slot,
    size_t family_slot
);
...
unsigned long long mylite_storage_test_dirty_page_buffer_merge_direct_write_guard_outcome_leaf_free_slot_detail_band_count(
    size_t outcome_slot,
    size_t band_slot
);
...
unsigned long long mylite_storage_test_dirty_page_buffer_merge_replaced_broad_victim_direct_write_lifecycle_start_count(
    size_t incoming_free_slot_detail_slot,
    size_t victim_free_slot_detail_slot,
    size_t initial_state_slot
);
unsigned long long mylite_storage_test_dirty_page_buffer_merge_replaced_broad_victim_direct_write_preserved_victim_replacement_count(
    size_t incoming_free_slot_detail_slot,
    size_t victim_free_slot_detail_slot,
    size_t initial_state_slot
);
unsigned long long mylite_storage_test_dirty_page_buffer_merge_replaced_broad_victim_direct_write_preserved_victim_flush_count(
    size_t source_slot,
    size_t incoming_free_slot_detail_slot,
    size_t victim_free_slot_detail_slot,
    size_t initial_state_slot,
    size_t final_state_slot
);
unsigned long long mylite_storage_test_dirty_page_buffer_merge_replaced_broad_victim_direct_write_preserved_victim_discard_count(
    size_t incoming_free_slot_detail_slot,
    size_t victim_free_slot_detail_slot,
    size_t initial_state_slot
);
unsigned long long mylite_storage_test_dirty_page_buffer_merge_replaced_broad_victim_direct_write_preserved_victim_clear_count(
    size_t incoming_free_slot_detail_slot,
    size_t victim_free_slot_detail_slot,
    size_t initial_state_slot
);
...
const char *mylite_storage_test_dirty_page_buffer_merge_fallback_parent_leaf_page_id_rank_slot_name(
    size_t slot
);
unsigned long long mylite_storage_test_dirty_page_buffer_merge_fallback_leaf_parent_rank_admission_count(
    size_t rank_slot,
    size_t outcome_slot,
...
unsigned long long mylite_storage_test_dirty_page_buffer_merge_fallback_leaf_flush_replacement_state_count(
    size_t source_slot,
    size_t outcome_slot,
    size_t free_slot_detail_slot,
    size_t state_slot
...
unsigned long long mylite_storage_test_dirty_page_buffer_merge_rejected_below_tail_direct_write_candidate_pressure_victim_dirty_family_count(
    size_t family_slot
);
...
unsigned long long mylite_storage_test_dirty_page_buffer_merge_rejected_below_tail_direct_write_candidate_pressure_victim_free_slot_replacement_state_matrix_count(
    size_t admitted_free_slot_detail_slot,
    size_t victim_free_slot_detail_slot,
    size_t state_slot
);
unsigned long long mylite_storage_test_dirty_page_buffer_merge_rejected_below_tail_direct_write_candidate_pressure_victim_replacement_state_matrix_count(
    size_t admitted_free_slot_detail_slot,
    size_t state_slot
);
...
unsigned long long mylite_storage_test_dirty_page_buffer_branch_fast_replacement_fact_publish_count(
    void
);
...
static void print_prepared_insert_storage_counters(void) {
    ...
    printf(
        "| branch fast replacement cached fact publications | %llu |\n",
        mylite_storage_test_dirty_page_buffer_branch_fast_replacement_fact_publish_count()
    );
    printf(
    ...
    printf(
        "| maintained-root cached fact publications | %llu |\n",
        mylite_storage_test_dirty_page_buffer_maintained_root_fact_publish_count()
    );
    printf(
    ...
    for (size_t site = 0U; site < maintained_root_decode_site_count; ++site) {
        const unsigned long long decode_count =
            mylite_storage_test_maintained_root_decode_site_count(site);
    ...
    printf("\nPrepared insert checksum-bound caches:\n\n");
    printf("| Counter | Value |\n");
    printf("| --- | ---: |\n");
    printf(
    ...
    printf(
        "| cached append-buffer refreshes | %llu |\n",
        mylite_storage_test_append_page_buffer_checksum_bound_refresh_count()
    );
    ...
    printf("\nPrepared insert dirty page copy pager-read sites by family:\n\n");
    printf("| Site | Page family | Copies | Dirty copies |\n");
    printf("| --- | --- | ---: | ---: |\n");
    const size_t pager_read_site_count =
        mylite_storage_test_dirty_page_copy_pager_read_site_slot_count();
    int printed_pager_read_site = 0;
    for (size_t site = 0U; site < pager_read_site_count; ++site) {
        const char *const site_name =
            mylite_storage_test_dirty_page_copy_pager_read_site_slot_name(site);
        for (size_t family = 0U; family < checksum_family_count; ++family) {
            const unsigned long long copy_count =
                mylite_storage_test_dirty_page_copy_pager_read_site_family_count(site, family);
            const unsigned long long dirty_copy_count =
                mylite_storage_test_dirty_page_copy_pager_read_site_dirty_family_count(
                    site,
                    family
                );
    ...
    printf("\nPrepared insert dirty page buffer flush pages by source and family:\n\n");
    printf("| Page family |");
    for (size_t i = 0U; i < dirty_flush_source_count; ++i) {
    ...
    for (size_t family = 0U; family < checksum_family_count; ++family) {
        ...
        for (size_t source = 0U; source < dirty_flush_source_count; ++source) {
            printf(
                " %llu |",
                mylite_storage_test_dirty_page_buffer_flush_family_page_count(source, family)
            );
        }
        printf("\n");
    }
    printf("\nPrepared insert dirty page buffer flush leaf shapes by source:\n\n");
    printf("| Leaf shape |");
    for (size_t i = 0U; i < dirty_flush_source_count; ++i) {
        printf(" %s |", mylite_storage_test_dirty_page_buffer_flush_source_slot_name(i));
    }
    ...
    printf("\n");
    const size_t dirty_flush_leaf_shape_count =
        mylite_storage_test_dirty_page_buffer_flush_leaf_shape_slot_count();
    for (size_t shape = 0U; shape < dirty_flush_leaf_shape_count; ++shape) {
        printf("| %s |", mylite_storage_test_dirty_page_buffer_flush_leaf_shape_slot_name(shape));
        for (size_t source = 0U; source < dirty_flush_source_count; ++source) {
            printf(
                " %llu |",
    ...
    printf("\nPrepared insert dirty page buffer flush leaf free slots by source:\n\n");
    printf("| Leaf free slots |");
    for (size_t i = 0U; i < dirty_flush_source_count; ++i) {
        printf(" %s |", mylite_storage_test_dirty_page_buffer_flush_source_slot_name(i));
    }
    printf("\n| --- |");
    ...
    printf("\n");
    const size_t dirty_flush_leaf_free_slot_band_count =
        mylite_storage_test_dirty_page_buffer_flush_leaf_free_slot_band_slot_count();
    for (size_t band = 0U; band < dirty_flush_leaf_free_slot_band_count; ++band) {
        printf(
            "| %s |",
            mylite_storage_test_dirty_page_buffer_flush_leaf_free_slot_band_slot_name(band)
        );
        for (size_t source = 0U; source < dirty_flush_source_count; ++source) {
            printf(
                " %llu |",
                mylite_storage_test_dirty_page_buffer_flush_leaf_free_slot_band_count(source, band)
            );
        }
        printf("\n");
    }
    ...
    printf("\nPrepared insert dirty page buffer flush leaf replacement state by free slots:\n\n");
    printf("| Source | Leaf replacement state | Leaf free slots | Flush pages |\n");
    printf("| --- | --- | --- | ---: |\n");
    int printed_leaf_replacement_state_free_slot = 0;
    for (size_t source = 0U; source < dirty_flush_source_count; ++source) {
        const char *const source_name =
            mylite_storage_test_dirty_page_buffer_flush_source_slot_name(source);
        for (size_t state = 0U; state < dirty_flush_leaf_replacement_state_count; ++state) {
            ...
            for (size_t band = 0U; band < dirty_flush_leaf_free_slot_band_count; ++band) {
                ...
                printed_leaf_replacement_state_free_slot = 1;
            }
        }
    }
    if (!printed_leaf_replacement_state_free_slot) {
        printf("| (none) | (none) | (none) | 0 |\n");
    }
    ...
    printf("\n");
    const size_t dirty_flush_leaf_page_id_rank_count =
        mylite_storage_test_dirty_page_buffer_flush_leaf_page_id_rank_slot_count();
    for (size_t rank = 0U; rank < dirty_flush_leaf_page_id_rank_count; ++rank) {
        ...
        for (size_t source = 0U; source < dirty_flush_source_count; ++source) {
            printf(
                " %llu |",
                mylite_storage_test_dirty_page_buffer_flush_leaf_page_id_rank_count(source, rank)
            );
        }
        printf("\n");
    }
    printf("\nPrepared insert dirty page buffer flush leaf page-id rank by fill band:\n\n");
    printf("| Source | Leaf page-id rank | Leaf fill band | Flush pages |\n");
    printf("| --- | --- | --- | ---: |\n");
    int printed_leaf_page_id_rank_fill_band = 0;
    for (size_t source = 0U; source < dirty_flush_source_count; ++source) {
        const char *const source_name =
            mylite_storage_test_dirty_page_buffer_flush_source_slot_name(source);
        for (size_t rank = 0U; rank < dirty_flush_leaf_page_id_rank_count; ++rank) {
            const char *const rank_name =
                mylite_storage_test_dirty_page_buffer_flush_leaf_page_id_rank_slot_name(rank);
            for (size_t band = 0U; band < dirty_flush_leaf_fill_band_count; ++band) {
                const unsigned long long flush_pages =
                    mylite_storage_test_dirty_page_buffer_flush_leaf_page_id_rank_fill_band_count(
                        source,
                        rank,
                        band
                    );
                ...
                printed_leaf_page_id_rank_fill_band = 1;
            }
        }
    }
    if (!printed_leaf_page_id_rank_fill_band) {
        printf("| (none) | (none) | (none) | 0 |\n");
    }
    printf("\nPrepared insert dirty page buffer flush write sites by source and family:\n\n");
    printf("| Site | Source | Page family | Flush pages | Checksum-dirty flush pages |\n");
    printf("| --- | --- | --- | ---: | ---: |\n");
    const size_t flush_write_site_count =
        mylite_storage_test_dirty_page_buffer_flush_write_site_slot_count();
    int printed_flush_write_site = 0;
    for (size_t site = 0U; site < flush_write_site_count; ++site) {
        const char *const site_name =
            mylite_storage_test_dirty_page_buffer_flush_write_site_slot_name(site);
        for (size_t source = 0U; source < dirty_flush_source_count; ++source) {
            const char *const source_name =
                mylite_storage_test_dirty_page_buffer_flush_source_slot_name(source);
            for (size_t family = 0U; family < checksum_family_count; ++family) {
                const unsigned long long flush_count =
                    mylite_storage_test_dirty_page_buffer_flush_write_site_family_count(
                        site,
                        source,
                        family
                    );
                const unsigned long long dirty_flush_count =
                    mylite_storage_test_dirty_page_buffer_flush_write_site_dirty_family_count(
                        site,
                        source,
                        family
                    );
                if (flush_count == 0ULL && dirty_flush_count == 0ULL) {
                    continue;
                }
                printf(
                    "| %s | %s | %s | %llu | %llu |\n",
                ...
                printed_flush_write_site = 1;
            }
        }
    }
    if (!printed_flush_write_site) {
        printf("| none | none | none | 0 | 0 |\n");
    }
    printf("\nPrepared insert dirty page buffer pressure incoming pages by family:\n\n");
    printf("| Page family | Incoming pages | Checksum-dirty incoming pages |\n");
    printf("| --- | ---: | ---: |\n");
    for (size_t family = 0U; family < checksum_family_count; ++family) {
        printf(
            "| %s | %llu | %llu |\n",
    ...
    printf("\nPrepared insert dirty page buffer pressure incoming leaf fill bands:\n\n");
    printf("| Leaf fill band | Incoming pages |\n");
    printf("| --- | ---: |\n");
    for (size_t band = 0U; band < dirty_flush_leaf_fill_band_count; ++band) {
        printf(
            "| %s | %llu |\n",
    ...
    printf("\nPrepared insert dirty page buffer pressure incoming leaf free-slot detail:\n\n");
    printf("| Leaf free slots | Incoming pages |\n");
    printf("| --- | ---: |\n");
    const size_t leaf_free_slot_detail_band_count =
        mylite_storage_test_dirty_page_buffer_leaf_free_slot_detail_band_slot_count();
    for (size_t band = 0U; band < leaf_free_slot_detail_band_count; ++band) {
        printf(
            ...
            mylite_storage_test_dirty_page_buffer_pressure_incoming_leaf_free_slot_detail_band_count(
                band
            )
        );
    }
    printf("\nPrepared insert dirty page buffer pressure admissions by source and family:\n\n");
    printf("| Admission source | Page family | Incoming pages | Checksum-dirty incoming pages |\n");
    printf("| --- | --- | ---: | ---: |\n");
    const size_t pressure_admission_source_count =
        mylite_storage_test_dirty_page_buffer_pressure_admission_source_slot_count();
    int printed_pressure_admission_source = 0;
    for (size_t source = 0U; source < pressure_admission_source_count; ++source) {
        const char *const source_name =
            mylite_storage_test_dirty_page_buffer_pressure_admission_source_slot_name(source);
        for (size_t family = 0U; family < checksum_family_count; ++family) {
            const unsigned long long incoming_count =
                mylite_storage_test_dirty_page_buffer_pressure_admission_source_family_count(
                    source,
                    family
                );
            const unsigned long long dirty_incoming_count =
                mylite_storage_test_dirty_page_buffer_pressure_admission_source_dirty_family_count(
                    source,
                    family
                );
            ...
            printed_pressure_admission_source = 1;
        }
    }
    if (!printed_pressure_admission_source) {
        printf("| none | none | 0 | 0 |\n");
    }
    printf(
        "\nPrepared insert dirty page buffer pressure admissions by buffered-entry "
        "replacement state and family:\n\n"
    );
    printf(
        "| Buffered entry replacement state | Page family | Incoming pages | "
        "Checksum-dirty incoming pages |\n"
    );
    printf("| --- | --- | ---: | ---: |\n");
    const size_t pressure_admission_entry_replacement_state_count =
        mylite_storage_test_dirty_page_buffer_pressure_admission_entry_replacement_state_slot_count();
    int printed_pressure_admission_entry_replacement_state = 0;
    for (size_t state = 0U; state < pressure_admission_entry_replacement_state_count; ++state) {
        const char *const state_name =
            mylite_storage_test_dirty_page_buffer_pressure_admission_entry_replacement_state_slot_name(
                state
            );
        for (size_t family = 0U; family < checksum_family_count; ++family) {
            const unsigned long long incoming_count =
                mylite_storage_test_dirty_page_buffer_pressure_admission_entry_replacement_state_family_count(
                    state,
                    family
                );
            const unsigned long long dirty_incoming_count =
                mylite_storage_test_dirty_page_buffer_pressure_admission_entry_replacement_state_dirty_family_count(
                    state,
                    family
                );
            if (incoming_count == 0ULL && dirty_incoming_count == 0ULL) {
            ...
            printed_pressure_admission_entry_replacement_state = 1;
        }
    }
    if (!printed_pressure_admission_entry_replacement_state) {
        printf("| none | none | 0 | 0 |\n");
    }
    ...
    printf(
        "| cached victim free-slot reads | %llu |\n",
        mylite_storage_test_dirty_page_buffer_merge_victim_free_slot_cached_count()
    );
    ...
    printf(
        "\nPrepared insert dirty page buffer merge direct-write guard leaf free-slot detail:\n\n"
    );
    printf("| Guard outcome | Leaf free slots | Pages |\n");
    printf("| --- | --- | ---: |\n");
    int printed_direct_write_guard_leaf_free_slot_detail_band = 0;
    for (size_t outcome = 0U; outcome < guard_outcome_count; ++outcome) {
        const char *const outcome_name =
            mylite_storage_test_dirty_page_buffer_merge_direct_write_guard_outcome_slot_name(
                outcome
        ...
        for (size_t band = 0U; band < leaf_free_slot_detail_band_count; ++band) {
            const unsigned long long page_count =
                mylite_storage_test_dirty_page_buffer_merge_direct_write_guard_outcome_leaf_free_slot_detail_band_count(
                    outcome,
                    band
                );
            if (page_count == 0ULL) {
            ...
            printed_direct_write_guard_leaf_free_slot_detail_band = 1;
        }
    }
    ...
    printf(
        "\nPrepared insert dirty page buffer merge replaced broad victim direct-write "
        "preserved victim lifecycle starts:\n\n"
    );
    printf(
        "| Incoming leaf free slots | Preserved victim leaf free slots | Initial preserved "
        "victim replacement state | Preserved victims |\n"
    );
    printf("| --- | --- | --- | ---: |\n");
    int printed_replaced_broad_victim_direct_write_lifecycle_start = 0;
    for (size_t incoming_band = 0U; incoming_band < leaf_free_slot_detail_band_count;
         ++incoming_band) {
        const char *const incoming_name =
            mylite_storage_test_dirty_page_buffer_leaf_free_slot_detail_band_slot_name(
        ...
        for (size_t victim_band = 0U; victim_band < leaf_free_slot_detail_band_count;
            ...
            for (size_t state = 0U; state < dirty_flush_leaf_replacement_state_count; ++state) {
                const unsigned long long preserved_count =
                    mylite_storage_test_dirty_page_buffer_merge_replaced_broad_victim_direct_write_lifecycle_start_count(
                        incoming_band,
                        victim_band,
                        state
                    );
                if (preserved_count == 0ULL) {
                    continue;
                }
                printf(
                    "| %s | %s | %s | %llu |\n",
                ...
                printed_replaced_broad_victim_direct_write_lifecycle_start = 1;
            }
        }
    }
    if (!printed_replaced_broad_victim_direct_write_lifecycle_start) {
        printf("| none | none | none | 0 |\n");
    }
    printf(
        "\nPrepared insert dirty page buffer merge replaced broad victim direct-write "
        "preserved victim replacements:\n\n"
    );
    printf(
        "| Incoming leaf free slots | Preserved victim leaf free slots | Initial preserved "
        "victim replacement state | Replacement events |\n"
    );
    printf("| --- | --- | --- | ---: |\n");
    int printed_replaced_broad_victim_direct_write_lifecycle_replacement = 0;
    for (size_t incoming_band = 0U; incoming_band < leaf_free_slot_detail_band_count;
         ++incoming_band) {
        const char *const incoming_name =
            mylite_storage_test_dirty_page_buffer_leaf_free_slot_detail_band_slot_name(
        ...
        for (size_t victim_band = 0U; victim_band < leaf_free_slot_detail_band_count;
            ...
            for (size_t state = 0U; state < dirty_flush_leaf_replacement_state_count; ++state) {
                const unsigned long long replacement_count =
                    mylite_storage_test_dirty_page_buffer_merge_replaced_broad_victim_direct_write_preserved_victim_replacement_count(
                        incoming_band,
                        victim_band,
                        state
                    );
                ...
                printed_replaced_broad_victim_direct_write_lifecycle_replacement = 1;
            }
        }
    }
    if (!printed_replaced_broad_victim_direct_write_lifecycle_replacement) {
        printf("| none | none | none | 0 |\n");
    }
    printf(
        "\nPrepared insert dirty page buffer merge replaced broad victim direct-write "
        "preserved victim flush states:\n\n"
    );
    printf(
        "| Source | Incoming leaf free slots | Preserved victim leaf free slots | Initial "
        "preserved victim replacement state | Final preserved victim replacement state | Flush "
        "pages |\n"
    );
    printf("| --- | --- | --- | --- | --- | ---: |\n");
    int printed_replaced_broad_victim_direct_write_lifecycle_flush = 0;
    for (size_t source = 0U; source < dirty_flush_source_count; ++source) {
        const char *const source_name =
            mylite_storage_test_dirty_page_buffer_flush_source_slot_name(source);
        for (size_t incoming_band = 0U; incoming_band < leaf_free_slot_detail_band_count;
            ...
            for (size_t victim_band = 0U; victim_band < leaf_free_slot_detail_band_count;
                ...
                for (size_t initial_state = 0U;
                     initial_state < dirty_flush_leaf_replacement_state_count;
                     ++initial_state) {
                    const char *const initial_state_name =
                        mylite_storage_test_dirty_page_buffer_flush_leaf_replacement_state_slot_name(
                            initial_state
                        );
                    for (size_t final_state = 0U;
                         final_state < dirty_flush_leaf_replacement_state_count;
                         ++final_state) {
                        const unsigned long long flush_count =
                            mylite_storage_test_dirty_page_buffer_merge_replaced_broad_victim_direct_write_preserved_victim_flush_count(
                                source,
                                incoming_band,
                                victim_band,
                                initial_state,
                        ...
                        printf(
                            ...
                            incoming_name != NULL ? incoming_name : "unknown",
                            victim_name != NULL ? victim_name : "unknown",
                            initial_state_name != NULL ? initial_state_name : "unknown",
                            mylite_storage_test_dirty_page_buffer_flush_leaf_replacement_state_slot_name(
                                final_state
                            ),
                            flush_count
                        );
                        printed_replaced_broad_victim_direct_write_lifecycle_flush = 1;
                    }
                }
            }
        }
    }
    if (!printed_replaced_broad_victim_direct_write_lifecycle_flush) {
    ...
    printf(
        "| Incoming leaf free slots | Preserved victim leaf free slots | Initial preserved "
        "victim replacement state | Discarded victims |\n"
    );
    printf("| --- | --- | --- | ---: |\n");
    int printed_replaced_broad_victim_direct_write_lifecycle_discard = 0;
    for (size_t incoming_band = 0U; incoming_band < leaf_free_slot_detail_band_count;
         ++incoming_band) {
        const char *const incoming_name =
            mylite_storage_test_dirty_page_buffer_leaf_free_slot_detail_band_slot_name(
        ...
        for (size_t victim_band = 0U; victim_band < leaf_free_slot_detail_band_count;
            ...
            for (size_t state = 0U; state < dirty_flush_leaf_replacement_state_count; ++state) {
                const unsigned long long discard_count =
                    mylite_storage_test_dirty_page_buffer_merge_replaced_broad_victim_direct_write_preserved_victim_discard_count(
                        incoming_band,
                        victim_band,
                        state
                    );
                ...
                printed_replaced_broad_victim_direct_write_lifecycle_discard = 1;
            }
        }
    }
    if (!printed_replaced_broad_victim_direct_write_lifecycle_discard) {
        printf("| none | none | none | 0 |\n");
    }
    printf(
        "\nPrepared insert dirty page buffer merge replaced broad victim direct-write "
    ...
    printf(
        "| Incoming leaf free slots | Preserved victim leaf free slots | Initial preserved "
        "victim replacement state | Cleared victims |\n"
    );
    printf("| --- | --- | --- | ---: |\n");
    int printed_replaced_broad_victim_direct_write_lifecycle_clear = 0;
    for (size_t incoming_band = 0U; incoming_band < leaf_free_slot_detail_band_count;
         ++incoming_band) {
        const char *const incoming_name =
            mylite_storage_test_dirty_page_buffer_leaf_free_slot_detail_band_slot_name(
        ...
        for (size_t victim_band = 0U; victim_band < leaf_free_slot_detail_band_count;
            ...
            for (size_t state = 0U; state < dirty_flush_leaf_replacement_state_count; ++state) {
                const unsigned long long clear_count =
                    mylite_storage_test_dirty_page_buffer_merge_replaced_broad_victim_direct_write_preserved_victim_clear_count(
                        incoming_band,
                        victim_band,
                        state
                    );
                ...
                printed_replaced_broad_victim_direct_write_lifecycle_clear = 1;
            }
        }
    }
    if (!printed_replaced_broad_victim_direct_write_lifecycle_clear) {
        printf("| none | none | none | 0 |\n");
    }
    ...
    printf("| --- | --- | --- | ---: |\n");
    const size_t merge_fallback_parent_rank_count =
        mylite_storage_test_dirty_page_buffer_merge_fallback_parent_leaf_page_id_rank_slot_count();
    int printed_merge_fallback_leaf_parent_rank_admission = 0;
    for (size_t rank = 0U; rank < merge_fallback_parent_rank_count; ++rank) {
        const char *const rank_name =
            mylite_storage_test_dirty_page_buffer_merge_fallback_parent_leaf_page_id_rank_slot_name(
                rank
            );
        for (size_t outcome = 0U; outcome < guard_outcome_count; ++outcome) {
            const char *const outcome_name =
            ...
            for (size_t band = 0U; band < leaf_free_slot_detail_band_count; ++band) {
                const unsigned long long admission_count =
                    mylite_storage_test_dirty_page_buffer_merge_fallback_leaf_parent_rank_admission_count(
                        rank,
                        outcome,
                        band
                    );
                ...
                printf(
                    "| %s | %s | %s | %llu |\n",
                    rank_name != NULL ? rank_name : "unknown",
                    outcome_name != NULL ? outcome_name : "unknown",
                    mylite_storage_test_dirty_page_buffer_leaf_free_slot_detail_band_slot_name(
                        band
                    ),
                ...
                printed_merge_fallback_leaf_parent_rank_admission = 1;
            }
        }
    }
    ...
    printf("| --- | --- | --- | ---: |\n");
    const size_t merge_fallback_leaf_change_count =
        mylite_storage_test_dirty_page_buffer_replacement_leaf_change_slot_count();
    int printed_merge_fallback_leaf_replacement = 0;
    for (size_t outcome = 0U; outcome < guard_outcome_count; ++outcome) {
        const char *const outcome_name =
            mylite_storage_test_dirty_page_buffer_merge_direct_write_guard_outcome_slot_name(
                outcome
        ...
        for (size_t band = 0U; band < leaf_free_slot_detail_band_count; ++band) {
            ...
            for (size_t change = 0U; change < merge_fallback_leaf_change_count; ++change) {
                const unsigned long long replacement_count =
                    mylite_storage_test_dirty_page_buffer_merge_fallback_leaf_replacement_count(
                        outcome,
                        band,
                        change
                    );
                ...
                printed_merge_fallback_leaf_replacement = 1;
            }
        }
    }
    if (!printed_merge_fallback_leaf_replacement) {
        printf("| none | none | none | 0 |\n");
    }
    printf("\nPrepared insert dirty page buffer merge fallback leaf parent-rank replacements:\n\n");
    printf(
        "| Parent leaf page-id rank | Guard outcome | Admitted leaf free slots | Leaf change "
        "class | Replacement pages |\n"
    );
    printf("| --- | --- | --- | --- | ---: |\n");
    int printed_merge_fallback_leaf_parent_rank_replacement = 0;
    for (size_t rank = 0U; rank < merge_fallback_parent_rank_count; ++rank) {
        const char *const rank_name =
            mylite_storage_test_dirty_page_buffer_merge_fallback_parent_leaf_page_id_rank_slot_name(
                rank
        ...
        for (size_t outcome = 0U; outcome < guard_outcome_count; ++outcome) {
            ...
            for (size_t band = 0U; band < leaf_free_slot_detail_band_count; ++band) {
                ...
                for (size_t change = 0U; change < merge_fallback_leaf_change_count; ++change) {
                    const unsigned long long replacement_count =
                        mylite_storage_test_dirty_page_buffer_merge_fallback_leaf_parent_rank_replacement_count(
                            rank,
                            outcome,
                            band,
                            change
                    ...
                    printed_merge_fallback_leaf_parent_rank_replacement = 1;
                }
            }
        }
    }
    ...
    printf(
        "| Source | Guard outcome | Admitted leaf free slots | Leaf replacement state | Flush "
        "pages |\n"
    );
    printf("| --- | --- | --- | --- | ---: |\n");
    int printed_merge_fallback_leaf_flush_replacement_state = 0;
    for (size_t source = 0U; source < dirty_flush_source_count; ++source) {
        const char *const source_name =
            mylite_storage_test_dirty_page_buffer_flush_source_slot_name(source);
        for (size_t outcome = 0U; outcome < guard_outcome_count; ++outcome) {
            ...
            for (size_t band = 0U; band < leaf_free_slot_detail_band_count; ++band) {
                ...
                for (size_t state = 0U; state < dirty_flush_leaf_replacement_state_count; ++state) {
                    const unsigned long long flush_count =
                        mylite_storage_test_dirty_page_buffer_merge_fallback_leaf_flush_replacement_state_count(
                            source,
                            outcome,
                            band,
                            state
                    ...
                    printed_merge_fallback_leaf_flush_replacement_state = 1;
                }
            }
        }
    }
    if (!printed_merge_fallback_leaf_flush_replacement_state) {
        printf("| none | none | none | none | 0 |\n");
    }
    printf(
        "\nPrepared insert dirty page buffer merge fallback leaf parent-rank flush replacement "
        "states:\n\n"
    );
    printf(
        "| Source | Parent leaf page-id rank | Guard outcome | Admitted leaf free slots | Leaf "
        "replacement state | Flush pages |\n"
    );
    printf("| --- | --- | --- | --- | --- | ---: |\n");
    int printed_merge_fallback_leaf_parent_rank_flush_replacement_state = 0;
    for (size_t source = 0U; source < dirty_flush_source_count; ++source) {
        const char *const source_name =
            mylite_storage_test_dirty_page_buffer_flush_source_slot_name(source);
        for (size_t rank = 0U; rank < merge_fallback_parent_rank_count; ++rank) {
            ...
            for (size_t outcome = 0U; outcome < guard_outcome_count; ++outcome) {
                ...
                for (size_t band = 0U; band < leaf_free_slot_detail_band_count; ++band) {
                    ...
                    for (size_t state = 0U; state < dirty_flush_leaf_replacement_state_count;
                         ++state) {
                        const unsigned long long flush_count =
                            mylite_storage_test_dirty_page_buffer_merge_fallback_leaf_parent_rank_flush_replacement_state_count(
                                source,
                                rank,
                                outcome,
                                band,
                        ...
                        printed_merge_fallback_leaf_parent_rank_flush_replacement_state = 1;
                    }
                }
            }
        }
    ...
    printf(
        "\nPrepared insert dirty page buffer merge rejected below-tail direct-write "
        "candidate pressure victims by family:\n\n"
    );
    printf("| Victim page family | Victim pages | Checksum-dirty victim pages |\n");
    printf("| --- | ---: | ---: |\n");
    int printed_rejected_below_tail_candidate_pressure_victim_family = 0;
    for (size_t family = 0U; family < checksum_family_count; ++family) {
        const unsigned long long victim_count =
            mylite_storage_test_dirty_page_buffer_merge_rejected_below_tail_direct_write_candidate_pressure_victim_family_count(
                family
            );
        const unsigned long long dirty_victim_count =
            mylite_storage_test_dirty_page_buffer_merge_rejected_below_tail_direct_write_candidate_pressure_victim_dirty_family_count(
                family
            );
        if (victim_count == 0ULL && dirty_victim_count == 0ULL) {
            continue;
        }
        printf(
            "| %s | %llu | %llu |\n",
        ...
        printed_rejected_below_tail_candidate_pressure_victim_family = 1;
    }
    if (!printed_rejected_below_tail_candidate_pressure_victim_family) {
        printf("| none | 0 | 0 |\n");
    }
    printf(
        "\nPrepared insert dirty page buffer merge rejected below-tail direct-write "
        "candidate pressure victim leaf replacement states:\n\n"
    );
    printf("| Leaf replacement state | Victim pages |\n");
    printf("| --- | ---: |\n");
    int printed_rejected_below_tail_candidate_pressure_victim_replacement_state = 0;
    for (size_t state = 0U; state < dirty_flush_leaf_replacement_state_count; ++state) {
        const unsigned long long victim_count =
    ...
    printf(
        "\nPrepared insert dirty page buffer merge rejected below-tail direct-write "
        "candidate pressure victim replacement-state matrix:\n\n"
    );
    printf("| Admitted leaf free slots | Victim leaf replacement state | Victim pages |\n");
    printf("| --- | --- | ---: |\n");
    int printed_rejected_below_tail_candidate_pressure_victim_replacement_state_matrix = 0;
    for (size_t admitted_band = 0U; admitted_band < leaf_free_slot_detail_band_count;
         ++admitted_band) {
        const char *const admitted_name =
            mylite_storage_test_dirty_page_buffer_leaf_free_slot_detail_band_slot_name(
        ...
        for (size_t state = 0U; state < dirty_flush_leaf_replacement_state_count; ++state) {
            ...
            printed_rejected_below_tail_candidate_pressure_victim_replacement_state_matrix = 1;
        }
    }
    if (!printed_rejected_below_tail_candidate_pressure_victim_replacement_state_matrix) {
        printf("| none | none | 0 |\n");
    }
    printf(
        "\nPrepared insert dirty page buffer merge rejected below-tail direct-write "
        "candidate pressure victim free-slot replacement-state matrix:\n\n"
    );
    printf(
        "| Admitted leaf free slots | Victim leaf free slots | Victim leaf replacement "
        "state | Victim pages |\n"
    );
    printf("| --- | --- | --- | ---: |\n");
    int printed_rejected_below_tail_candidate_pressure_victim_free_slot_replacement_state_matrix =
        0;
    for (size_t admitted_band = 0U; admitted_band < leaf_free_slot_detail_band_count;
         ++admitted_band) {
        const char *const admitted_name =
        ...
        for (size_t victim_band = 0U; victim_band < leaf_free_slot_detail_band_count;
            ...
            for (size_t state = 0U; state < dirty_flush_leaf_replacement_state_count; ++state) {
                const unsigned long long victim_count =
                    mylite_storage_test_dirty_page_buffer_merge_rejected_below_tail_direct_write_candidate_pressure_victim_free_slot_replacement_state_matrix_count(
                        admitted_band,
                        victim_band,
                        state
                    );
                ...
                printed_rejected_below_tail_candidate_pressure_victim_free_slot_replacement_state_matrix =
                    1;
            }
        }
    }
    if (!printed_rejected_below_tail_candidate_pressure_victim_free_slot_replacement_state_matrix) {
        printf("| none | none | none | 0 |\n");
    }
    printf(
        "\nPrepared insert dirty page buffer merge rejected below-tail direct-write "
    ...
    printf("\nPrepared insert dirty page buffer leaf growth fast replacements:\n\n");
    printf("| Leaf change class | Fast replacements |\n");
    printf("| --- | ---: |\n");
    for (size_t slot = 0U; slot < replacement_leaf_change_count; ++slot) {
        printf(
            "| %s | %llu |\n",
            mylite_storage_test_dirty_page_buffer_replacement_leaf_change_slot_name(slot),
            mylite_storage_test_dirty_page_buffer_leaf_growth_fast_replacement_change_count(slot)
        );
    }
