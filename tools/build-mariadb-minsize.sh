...
write_build_report() {
...

  {
    ...
    grep -E "^(AWS_SDK_EXTERNAL_PROJECT|BUILD_CONFIG|CMAKE_((C|CXX)_FLAGS_MINSIZEREL|(EXE|MODULE|SHARED)_LINKER_FLAGS)|DEFAULT_COLLATION|DISABLE_SHARED|ENABLED_PROFILING|FEATURE_SET|MYLITE_(DISABLE|ENABLE)_[A-Z0-9_]+|PLUGIN_[A-Z0-9_]+|UPDATE_SUBMODULES|USE_ARIA_FOR_TMP_TABLES|WITH_[A-Z0-9_]+|WITHOUT_DYNAMIC_PLUGINS):" \
