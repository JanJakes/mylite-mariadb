...
/* The shared generation reached its terminal value and the state is immutable. */
#define MYLITE_OWNERLESS_DICTIONARY_STATE_EXHAUSTED 4
...
#define MYLITE_OWNERLESS_DICTIONARY_RECOVERY_ALTER_TABLE_AUTO_INCREMENT 55U
