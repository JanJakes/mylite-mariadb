...
#define MYLITE_OWNERLESS_TABLESPACE_REPLAY_KEEP_NATIVE_SAME_LSN 0x2U
#define MYLITE_OWNERLESS_TABLESPACE_REPLAY_KEEP_NATIVE_SAME_LSN_SNAPSHOT_BOUNDARY 0x4U
#define MYLITE_OWNERLESS_TABLESPACE_REPLAY_USER_TABLESPACES_ONLY 0x8U
