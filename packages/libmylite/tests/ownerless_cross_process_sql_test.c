...
int main(int argc, char **argv) {
    ...
    if (argc != 1) {
        fprintf(
            ...
            "table-comment-ddl|column-default-ddl|view-ddl|trigger-ddl|routine-policy|"
            "index-ddl|rename-index-ddl|ignored-index-ddl|unique-index-ddl|primary-key-ddl|"
            "foreign-key-ddl|check-constraint-ddl|"
