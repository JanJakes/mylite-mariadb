...
#define mylite_ownerless_lock_table_acquire_upgradable(mapping, size, key, owner, timeout)         \
...
#define mylite_ownerless_lock_table_release_upgradable(mapping, size, key, owner)                  \
...
#define mylite_ownerless_mdl_acquire_upgradable(table, size, owner, ns, db, object, timeout)       \
...
#define mylite_ownerless_mdl_release_upgradable(table, size, owner, ns, db, object)                \
...
#define mylite_ownerless_trx_registry_snapshot_read_view(                                          \
    mapping,                                                                                       \
    size,                                                                                          \
    ids,                                                                                           \
    cap,                                                                                           \
...
#define mylite_ownerless_read_view_registry_snapshot_oldest(                                       \
    mapping,                                                                                       \
    size,                                                                                          \
    ids,                                                                                           \
    cap,                                                                                           \
...
#define mylite_ownerless_innodb_lock_registry_acquire_table(                                       \
    mapping,                                                                                       \
    size,                                                                                          \
    owner,                                                                                         \
    trx,                                                                                           \
...
#define mylite_ownerless_innodb_lock_registry_reserve_table(                                       \
    mapping,                                                                                       \
    size,                                                                                          \
    owner,                                                                                         \
    trx,                                                                                           \
...
#define mylite_ownerless_innodb_lock_registry_release_table(                                       \
    mapping,                                                                                       \
    size,                                                                                          \
    owner,                                                                                         \
    trx,                                                                                           \
...
#define mylite_ownerless_innodb_lock_registry_wait_for_table(                                      \
    mapping,                                                                                       \
    size,                                                                                          \
    owner,                                                                                         \
    trx,                                                                                           \
...
#define mylite_ownerless_innodb_lock_registry_wait_until_table_available(                          \
    mapping,                                                                                       \
    size,                                                                                          \
    owner,                                                                                         \
    trx,                                                                                           \
...
#define mylite_ownerless_innodb_lock_registry_acquire_record(                                      \
    mapping,                                                                                       \
    size,                                                                                          \
    owner,                                                                                         \
    trx,                                                                                           \
...
#define mylite_ownerless_innodb_lock_registry_reserve_record(                                      \
    mapping,                                                                                       \
    size,                                                                                          \
    owner,                                                                                         \
    trx,                                                                                           \
...
#define mylite_ownerless_innodb_lock_registry_release_record(                                      \
    mapping,                                                                                       \
    size,                                                                                          \
    owner,                                                                                         \
    trx,                                                                                           \
...
#define mylite_ownerless_innodb_lock_registry_wait_for_record(                                     \
    mapping,                                                                                       \
    size,                                                                                          \
    owner,                                                                                         \
    trx,                                                                                           \
...
#define mylite_ownerless_innodb_lock_registry_wait_until_record_available(                         \
    mapping,                                                                                       \
    size,                                                                                          \
    owner,                                                                                         \
    trx,                                                                                           \
