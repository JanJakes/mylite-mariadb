...
typedef struct bulk_insert_timing {
    uint64_t first_statement_ns;
    uint64_t remaining_statements_ns;
    unsigned first_statement_rows;
    unsigned remaining_statement_rows;
    unsigned first_statement_count;
...
enum page_write_perf_stat_index {
    ...
    PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_SPACE_LEAVE_NS,
    PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_PAGE_PUBLISH_NS,
    PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_PAGE_LEAVE_NS,
...
enum embedded_startup_perf_stat_index {
    ...
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_CALLS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_TOTAL_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_EARLY_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_BOOT_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_TMPFILES_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_CORE_SYSTEMS_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_CHECKPOINT_OR_CREATE_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_SYS_SPACE_OPEN_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_UNDO_INIT_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_NEW_DB_BOOTSTRAP_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_RECOVERY_BOOTSTRAP_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_LOG_REBUILD_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_DOUBLEWRITE_UNDO_NS,
    EMBEDDED_STARTUP_PERF_INNODB_SRV_START_ROLLBACK_LOAD_NS,
...
int main(void) {
    ...
    double ordinary_insert_autocommit_bulk_first_statement_row_rate;
    double ordinary_insert_autocommit_bulk_first_statement_rate;
    double ordinary_insert_autocommit_bulk_remaining_row_rate;
    double ordinary_insert_autocommit_bulk_remaining_statement_rate;
    ...
    double ownerless_insert_autocommit_bulk_first_statement_row_rate;
    double ownerless_insert_autocommit_bulk_first_statement_rate;
    double ownerless_insert_autocommit_bulk_remaining_row_rate;
    double ownerless_insert_autocommit_bulk_remaining_statement_rate;
    ...
    emit_rate(
        "mylite_perf_ordinary_insert_autocommit_bulk_first_statement_rows",
        ordinary_bulk_timing.first_statement_rows,
        (double)ordinary_bulk_timing.first_statement_ns / 1000000000.0
    );
    emit_rate(
        "mylite_perf_ordinary_insert_autocommit_bulk_first_statement",
        ordinary_bulk_timing.first_statement_count,
        (double)ordinary_bulk_timing.first_statement_ns / 1000000000.0
    );
    emit_rate(
        "mylite_perf_ordinary_insert_autocommit_bulk_remaining_rows",
        ordinary_bulk_timing.remaining_statement_rows,
        (double)ordinary_bulk_timing.remaining_statements_ns / 1000000000.0
    );
    emit_rate(
        "mylite_perf_ordinary_insert_autocommit_bulk_remaining_statements",
        ordinary_bulk_timing.remaining_statement_count,
        (double)ordinary_bulk_timing.remaining_statements_ns / 1000000000.0
    );
    if (page_publish_stats) {
    ...
    ordinary_insert_autocommit_bulk_first_statement_row_rate = operations_per_second(
        ordinary_bulk_timing.first_statement_rows,
        (double)ordinary_bulk_timing.first_statement_ns / 1000000000.0
    );
    ordinary_insert_autocommit_bulk_first_statement_rate = operations_per_second(
        ordinary_bulk_timing.first_statement_count,
        (double)ordinary_bulk_timing.first_statement_ns / 1000000000.0
    );
    ordinary_insert_autocommit_bulk_remaining_row_rate = operations_per_second(
        ordinary_bulk_timing.remaining_statement_rows,
        (double)ordinary_bulk_timing.remaining_statements_ns / 1000000000.0
    );
    ordinary_insert_autocommit_bulk_remaining_statement_rate = operations_per_second(
        ordinary_bulk_timing.remaining_statement_count,
        (double)ordinary_bulk_timing.remaining_statements_ns / 1000000000.0
    );
    close_database(db);
    ...
    emit_rate(
        "mylite_perf_ownerless_insert_autocommit_bulk_first_statement_rows",
        ownerless_bulk_timing.first_statement_rows,
        (double)ownerless_bulk_timing.first_statement_ns / 1000000000.0
    );
    emit_rate(
        "mylite_perf_ownerless_insert_autocommit_bulk_first_statement",
        ownerless_bulk_timing.first_statement_count,
        (double)ownerless_bulk_timing.first_statement_ns / 1000000000.0
    );
    emit_rate(
        "mylite_perf_ownerless_insert_autocommit_bulk_remaining_rows",
        ownerless_bulk_timing.remaining_statement_rows,
        (double)ownerless_bulk_timing.remaining_statements_ns / 1000000000.0
    );
    emit_rate(
        "mylite_perf_ownerless_insert_autocommit_bulk_remaining_statements",
        ownerless_bulk_timing.remaining_statement_count,
        (double)ownerless_bulk_timing.remaining_statements_ns / 1000000000.0
    );
    if (page_publish_stats) {
        mylite_exec_result_perf_set_enabled(0);
    ...
    ownerless_insert_autocommit_bulk_statement_rate =
        operations_per_second(bulk_insert_statements, seconds);
    ownerless_insert_autocommit_bulk_first_statement_row_rate = operations_per_second(
        ownerless_bulk_timing.first_statement_rows,
        (double)ownerless_bulk_timing.first_statement_ns / 1000000000.0
    );
    ownerless_insert_autocommit_bulk_first_statement_rate = operations_per_second(
        ownerless_bulk_timing.first_statement_count,
        (double)ownerless_bulk_timing.first_statement_ns / 1000000000.0
    );
    ownerless_insert_autocommit_bulk_remaining_row_rate = operations_per_second(
        ownerless_bulk_timing.remaining_statement_rows,
        (double)ownerless_bulk_timing.remaining_statements_ns / 1000000000.0
    );
    ownerless_insert_autocommit_bulk_remaining_statement_rate = operations_per_second(
        ownerless_bulk_timing.remaining_statement_count,
        (double)ownerless_bulk_timing.remaining_statements_ns / 1000000000.0
    );
    close_database(db);
    ...
    emit_summary_rate(
        "mylite_perf_summary_ordinary_insert_autocommit_bulk_first_statement_rows_ops_per_second",
        ordinary_insert_autocommit_bulk_first_statement_row_rate
    );
    emit_summary_rate(
        "mylite_perf_summary_ownerless_insert_autocommit_bulk_first_statement_rows_ops_per_second",
        ownerless_insert_autocommit_bulk_first_statement_row_rate
    );
    emit_summary_ratio(
        "mylite_perf_summary_ownerless_insert_autocommit_bulk_first_statement_rows_ratio",
        ownerless_insert_autocommit_bulk_first_statement_row_rate,
        ordinary_insert_autocommit_bulk_first_statement_row_rate
    );
    emit_summary_rate(
        "mylite_perf_summary_ordinary_insert_autocommit_bulk_first_statement_ops_per_second",
        ordinary_insert_autocommit_bulk_first_statement_rate
    );
    emit_summary_rate(
        "mylite_perf_summary_ownerless_insert_autocommit_bulk_first_statement_ops_per_second",
        ownerless_insert_autocommit_bulk_first_statement_rate
    );
    emit_summary_ratio(
        "mylite_perf_summary_ownerless_insert_autocommit_bulk_first_statement_ratio",
        ownerless_insert_autocommit_bulk_first_statement_rate,
        ordinary_insert_autocommit_bulk_first_statement_rate
    );
    emit_summary_rate(
        "mylite_perf_summary_ordinary_insert_autocommit_bulk_remaining_rows_ops_per_second",
        ordinary_insert_autocommit_bulk_remaining_row_rate
    );
    emit_summary_rate(
        "mylite_perf_summary_ownerless_insert_autocommit_bulk_remaining_rows_ops_per_second",
        ownerless_insert_autocommit_bulk_remaining_row_rate
    );
    emit_summary_ratio(
        "mylite_perf_summary_ownerless_insert_autocommit_bulk_remaining_rows_ratio",
        ownerless_insert_autocommit_bulk_remaining_row_rate,
        ordinary_insert_autocommit_bulk_remaining_row_rate
    );
    emit_summary_rate(
        "mylite_perf_summary_ordinary_insert_autocommit_bulk_remaining_statements_ops_per_second",
        ordinary_insert_autocommit_bulk_remaining_statement_rate
    );
    emit_summary_rate(
        "mylite_perf_summary_ownerless_insert_autocommit_bulk_remaining_statements_ops_per_second",
        ownerless_insert_autocommit_bulk_remaining_statement_rate
    );
    emit_summary_ratio(
        "mylite_perf_summary_ownerless_insert_autocommit_bulk_remaining_statements_ratio",
        ownerless_insert_autocommit_bulk_remaining_statement_rate,
        ordinary_insert_autocommit_bulk_remaining_statement_rate
    );
...
static void emit_ownerless_bulk_autocommit_phase_summary(
    ...
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_bulk_page_write_commit_log_ms_per_row",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_TOTAL_NS],
        insert_rows
    );
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_bulk_page_write_commit_log_ms_per_statement",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_TOTAL_NS],
        insert_statements
    );
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_bulk_page_write_commit_log_redo_leave_ms_per_"
        "statement",
    ...
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_bulk_page_write_commit_log_no_dirty_loop_ms_"
        "per_statement",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_LOOP_NS],
        insert_statements
    );
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_bulk_page_write_commit_log_no_dirty_space_"
        "leave_ms_per_statement",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_SPACE_LEAVE_NS],
        insert_statements
    );
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_bulk_page_write_commit_log_no_dirty_page_"
        "publish_ms_per_statement",
...
static void emit_bulk_deep_ms_value(
    const char *prefix,
    const char *metric,
    const char *unit_name,
    uint64_t value_ns,
    ...
    printf("%s_%s_ms_per_%s=%.3f\n", prefix, metric, unit_name, average_ms);
}

static void emit_bulk_deep_ms_delta(
    const char *metric,
    const char *unit_name,
    uint64_t ordinary_ns,
    uint64_t ownerless_ns,
    unsigned iterations
) {
    const double total_ms = ((double)ownerless_ns - (double)ordinary_ns) / 1000000.0;
    const double average_ms = iterations > 0U ? total_ms / (double)iterations : 0.0;

    printf(
        "mylite_perf_summary_ownerless_minus_ordinary_autocommit_bulk_%s_ms_per_%s=%.3f\n",
        metric,
        unit_name,
        average_ms
    );
...
static void emit_bulk_deep_ms_pair_for_unit(
    const uint64_t *ordinary_deep,
    const uint64_t *ownerless_deep,
    size_t index,
    const char *metric,
...
static void emit_bulk_deep_ms_pair(
    const uint64_t *ordinary_deep,
    const uint64_t *ownerless_deep,
    size_t index,
    const char *metric,
    ...
    emit_bulk_deep_ms_pair_for_unit(
        ordinary_deep,
        ownerless_deep,
        index,
        metric,
...
static void emit_bulk_deep_count_value(
    ...
    printf("%s_%s_per_%s=%.3f\n", prefix, metric, unit_name, average);
}

static void emit_bulk_deep_count_delta(
    const char *metric,
    const char *unit_name,
    uint64_t ordinary_count,
    uint64_t ownerless_count,
    unsigned iterations
) {
    const double total = (double)ownerless_count - (double)ordinary_count;
    const double average = iterations > 0U ? total / (double)iterations : 0.0;

    printf(
        "mylite_perf_summary_ownerless_minus_ordinary_autocommit_bulk_%s_per_%s=%.3f\n",
        metric,
        unit_name,
        average
    );
...
static void emit_bulk_deep_count_pair_for_unit(
    const uint64_t *ordinary_deep,
    const uint64_t *ownerless_deep,
    size_t index,
    const char *metric,
...
static void emit_bulk_deep_count_pair(
    const uint64_t *ordinary_deep,
    const uint64_t *ownerless_deep,
    size_t index,
    const char *metric,
    ...
    emit_bulk_deep_count_pair_for_unit(
        ordinary_deep,
        ownerless_deep,
        index,
        metric,
...
static void emit_ownerless_transaction_phase_summary(
    ...
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_insert_txn_page_write_commit_log_no_dirty_space_leave_ms_"
        "per_insert",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_SPACE_LEAVE_NS],
        insert_iterations
    );
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_insert_txn_page_write_commit_log_no_dirty_page_publish_ms_"
        "per_insert",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_PAGE_PUBLISH_NS],
        insert_iterations
    );
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_insert_txn_page_write_commit_log_no_dirty_page_leave_ms_"
        "per_insert",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_PAGE_LEAVE_NS],
        insert_iterations
    );
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_insert_txn_page_write_commit_log_no_dirty_page_unlock_ms_"
        "per_insert",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_PAGE_UNLOCK_NS],
        insert_iterations
    );
...
static void emit_ownerless_autocommit_phase_summary(unsigned insert_iterations) {
    ...
    emit_summary_count_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_checkpoint_update_generation_cache_hits_per_"
        "insert",
        database_perf[DATABASE_PERF_STAT_CHECKPOINT_UPDATE_GENERATION_CACHE_HITS],
        insert_iterations
    );
    emit_summary_count_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_checkpoint_update_legacy_write_elided_per_"
        "insert",
        database_perf[DATABASE_PERF_STAT_CHECKPOINT_UPDATE_LEGACY_WRITE_ELIDED],
        insert_iterations
    );
    emit_summary_count_per_iteration(
    ...
    emit_summary_count_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_page_log_delta_exact_reused_fast_payload_records_"
        "per_insert",
        page_log_append[PAGE_LOG_APPEND_PERF_STAT_DELTA_EXACT_REUSED_FAST_PAYLOAD_RECORDS],
        insert_iterations
    );
    emit_summary_count_per_iteration(
    ...
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_page_write_commit_log_no_dirty_space_leave_ms_"
        "per_insert",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_SPACE_LEAVE_NS],
        insert_iterations
    );
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_page_write_commit_log_no_dirty_page_publish_ms_"
        "per_insert",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_PAGE_PUBLISH_NS],
        insert_iterations
    );
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_page_write_commit_log_no_dirty_page_leave_ms_"
        "per_insert",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_PAGE_LEAVE_NS],
        insert_iterations
    );
    emit_summary_ms_per_iteration(
        "mylite_perf_summary_ownerless_autocommit_page_write_commit_log_no_dirty_page_unlock_ms_"
        "per_insert",
        page_write[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_PAGE_UNLOCK_NS],
        insert_iterations
    );
...
static void emit_database_perf_stats(const char *prefix) {
    ...
    printf(
        "%s_checkpoint_update_generation_cache_hits=%" PRIu64 "\n",
        prefix,
        values[DATABASE_PERF_STAT_CHECKPOINT_UPDATE_GENERATION_CACHE_HITS]
    );
    printf(
        "%s_checkpoint_update_legacy_write_elided=%" PRIu64 "\n",
        prefix,
        values[DATABASE_PERF_STAT_CHECKPOINT_UPDATE_LEGACY_WRITE_ELIDED]
    );
    printf(
...
static void emit_embedded_startup_perf_summary(const char *prefix) {
    ...
    emit_embedded_startup_perf_summary_ms(
        prefix,
        "innodb_srv_start_total",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_TOTAL_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_summary_ms(
        prefix,
        "innodb_srv_start_core_systems",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_CORE_SYSTEMS_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_summary_ms(
        prefix,
        "innodb_srv_start_checkpoint_or_create",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_CHECKPOINT_OR_CREATE_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_summary_ms(
        prefix,
        "innodb_srv_start_sys_space_open",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_SYS_SPACE_OPEN_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_summary_ms(
        prefix,
        "innodb_srv_start_recovery_bootstrap",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_RECOVERY_BOOTSTRAP_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_summary_ms(
        prefix,
        "innodb_srv_start_log_rebuild",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_LOG_REBUILD_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_summary_ms(
        prefix,
        "innodb_srv_start_doublewrite_undo",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_DOUBLEWRITE_UNDO_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_summary_ms(
        prefix,
        "innodb_srv_start_system_tables",
...
static void emit_embedded_startup_perf_stats(const char *prefix) {
    ...
    emit_embedded_startup_perf_value(prefix, "innodb_srv_start_calls", innodb_srv_start_calls);
    emit_embedded_startup_perf_ms(
        prefix,
        "innodb_srv_start_total",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_TOTAL_NS],
    ...
    emit_embedded_startup_perf_ms(
        prefix,
        "innodb_srv_start_early",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_EARLY_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_ms(
        prefix,
        "innodb_srv_start_boot",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_BOOT_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_ms(
        prefix,
        "innodb_srv_start_tmpfiles",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_TMPFILES_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_ms(
        prefix,
    ...
    emit_embedded_startup_perf_ms(
        prefix,
        "innodb_srv_start_undo_init",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_UNDO_INIT_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_ms(
        prefix,
        "innodb_srv_start_new_db_bootstrap",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_NEW_DB_BOOTSTRAP_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_ms(
        prefix,
    ...
    emit_embedded_startup_perf_ms(
        prefix,
        "innodb_srv_start_rollback_load",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_ROLLBACK_LOAD_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_ms(
        prefix,
        "innodb_srv_start_background",
        values[EMBEDDED_STARTUP_PERF_INNODB_SRV_START_BACKGROUND_NS],
        innodb_srv_start_calls
    );
    emit_embedded_startup_perf_ms(
        prefix,
...
static void emit_page_write_perf_stats(const char *prefix) {
    ...
    printf(
        "%s_page_write_commit_log_no_dirty_space_leave_ms=%.3f\n",
        prefix,
        (double)values[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_SPACE_LEAVE_NS] / 1000000.0
    );
    printf(
        "%s_page_write_commit_log_no_dirty_page_publish_ms=%.3f\n",
        prefix,
        (double)values[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_PAGE_PUBLISH_NS] / 1000000.0
    );
    printf(
        "%s_page_write_commit_log_no_dirty_page_leave_ms=%.3f\n",
        prefix,
        (double)values[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_PAGE_LEAVE_NS] / 1000000.0
    );
    printf(
        "%s_page_write_commit_log_no_dirty_page_unlock_ms=%.3f\n",
        prefix,
        (double)values[PAGE_WRITE_PERF_STAT_COMMIT_LOG_NO_DIRTY_PAGE_UNLOCK_NS] / 1000000.0
    );
}
...
static void emit_page_log_append_perf_stats(const char *prefix) {
    ...
    emit_page_log_append_perf_count(
        prefix,
        "delta_exact_reused_fast_payload_records",
        values[PAGE_LOG_APPEND_PERF_STAT_DELTA_EXACT_REUSED_FAST_PAYLOAD_RECORDS]
    );
    emit_page_log_append_perf_bytes(
        prefix,
...
static double measure_bulk_autocommit_insert(
    ...
    while (next_id <= rows) {
        ...
        uint64_t statement_start_ns;
        uint64_t statement_end_ns;
        ...
        statement_start_ns = monotonic_ns();
        exec_ok(db, sql);
        statement_end_ns = monotonic_ns();
        if (timing != NULL) {
            const uint64_t statement_ns = statement_end_ns - statement_start_ns;
            if (timing->first_statement_count == 0U) {
