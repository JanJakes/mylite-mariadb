...
storage-engine discovery or routing, compatibility coverage, single-file
catalog, build trimming, crash recovery, DDL metadata routing, wire-protocol
...
- Single-file, embedded-runtime, compatibility, storage-routing,
