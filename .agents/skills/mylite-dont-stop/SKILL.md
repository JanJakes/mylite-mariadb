...
`git status`, routine commits, routine pushes, single-file copy edits, small
...
- Attack the central MariaDB fork, embedded lifecycle, single-file storage, or
  build problem first; let scaffolding follow.
