...
description: Manage MyLite upstream MariaDB import, rebase, or patch-stack work with clean fork discipline, recorded refs, separated upstream and local changes, and verification. Use for upstream source import/rebase/update work, not ordinary docs edits or isolated first-party changes.
---
...
7. Update docs when an upstream change affects embedded bootstrap, handler APIs,
   storage discovery, build options, or licensing assumptions.
