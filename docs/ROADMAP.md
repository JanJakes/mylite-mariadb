...
| 17 | Application schemas | 🟡&nbsp;In&nbsp;progress | Broader WordPress-shaped core-table smoke coverage is implemented for options, posts, postmeta, users, usermeta, terms, taxonomy relationships, comments, commentmeta, and links with representative `utf8mb4_unicode_ci` defaults; a WordPress 6.9.4 single-site installer DDL fixture imports through omitted-engine routing; full WordPress runtime install, installer data seeding, broader collation suites, ORM suites, multisite, and plugin schemas remain. |
