...
| 11 | Row and index storage | 🟡&nbsp;In&nbsp;progress | Keyless table insert and full-scan storage is implemented for non-BLOB rows, including NULL values; primary/secondary indexes, uniqueness, autoincrement, BLOB/TEXT overflow, update/delete, and copy `ALTER` rebuilds remain. |
