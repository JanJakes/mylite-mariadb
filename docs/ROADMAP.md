...
has a validated branch-page format with binary child selection over high
`(key, row_id)` fences; production B-tree root publication, split/merge, and
multi-page branch maintenance remain pending. SQL copy-rebuild DDL now
