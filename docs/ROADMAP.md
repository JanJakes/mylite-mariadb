...
appended leaf's child cell in branch order. Eligible final-child removals now
...
merge/redistribution, higher-adjacent and arbitrary-chain free-list coalescing,
