...
| 11 | Row and index storage | 🟡&nbsp;In&nbsp;progress | Table insert, full-scan, update/delete, copy rebuild, NULL values, BLOB/TEXT overflow payloads, autoincrement state, supported primary/unique/secondary index entries, and standalone supported index DDL are implemented; truncate, BLOB/TEXT indexes, compaction, and transactional index maintenance remain. |
