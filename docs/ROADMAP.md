...
upstream test files through the harness inventory, with 4,422 upstream MTR
...
DES/SFORMAT, `INSERT DELAYED`, static SHOW, plugin inventory/origin,
big-processlist, upstream-disabled MEMORY placeholder, packaging-file, and
daemon-status probes, plus generated/virtual-column JSON_TABLE,
replication/binlog, query-cache, file-I/O, partition, trigger, view, and
external dump probes. The
