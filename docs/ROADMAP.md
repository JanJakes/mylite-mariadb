...
last leaf has room. Full-leaf inserts continue to use the append-tail fallback.
Split/merge and broader branch update/delete maintenance remain pending. SQL copy-rebuild DDL now
