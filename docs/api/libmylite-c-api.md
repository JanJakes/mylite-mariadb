...
simple nullable child columns. The subset is advertised to MariaDB through the
MyLite handlerton. Broader multi-table matrices, explicit same-row action
override matrices, cascades, and recursive FK action chains remain unsupported.
Session
