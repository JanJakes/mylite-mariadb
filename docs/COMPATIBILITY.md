...
recovery now allows live-peer dictionary cleanup after the native compressed
copy rebuild; compressed key-block sizes `1`, `2`, `4`, and `16` and other
ALTER rebuild live recovery remain planned.
...
compressed key-block `1`, `2`, `4`, and `16` row-format rebuild, schema, view,
