...
creation, rewrite, or removal. `DROP TEMPORARY TABLE`, multi-table
`DROP TABLE IF EXISTS` lists,
inside-MariaDB-loop multi-drop crash points, view-only rename forms,
partition/FK truncate variants, broader ALTER rebuild, schema idempotent/no-op
and synonym variants, broader view and trigger variants, and non-rename
