...
`FILE_MODIFY`, native mid-rollback crash, concurrent-writer savepoint,
DDL/file lifecycle, or concurrent-writer explicit transaction path has been
exhaustively classified. Hook-build coverage now also kills a writer after
