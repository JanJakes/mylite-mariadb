...
Pure comma-separated ordinary foreign-key ADD/DROP ALTER lists now use
metadata-only live-peer recovery with clear native file-operation markers.
...
trigger variants, and mixed non-rename foreign-key multi-DDL live-peer recovery
