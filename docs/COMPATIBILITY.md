...
missing durable source pairs produce warnings while temp-first and
permanent-first real mixed lists preserve the permanent target, keep skipped
targets absent, keep the temporary target session-local and absent after crash,
retain the native file-operation marker while a peer is live, drain it after
no-live recovery, and survive ownerless/native reopen plus forced `.shm`
rebuild.
