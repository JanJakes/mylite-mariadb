...
duplicate modes, temporary LIKE/CTAS isolation and shadowing, representative OR
REPLACE replacement and failed replacement rollback, standalone index DDL,
