...
security/definer, `ALTER ALGORITHM=TEMPTABLE VIEW`, and idempotent/no-op view
forms now have metadata-only live-peer recovery without native file-operation
marker evidence. Simple
