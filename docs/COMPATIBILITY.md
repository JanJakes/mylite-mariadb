...
`INSERT ... VALUES` statements with one through 4096 row constructors, matching
...
2048-row, plus 4096-row bulk diagnostics while keeping larger row lists and
