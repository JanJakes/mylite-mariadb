...
column-list, check-option create/replacement/alter, nested check-option, and
security/definer plus idempotent/no-op view forms now have metadata-only
live-peer recovery without native file-operation marker evidence. Simple
