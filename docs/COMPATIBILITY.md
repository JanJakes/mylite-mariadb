...
column-list and check-option create/replacement/alter view forms now have
metadata-only live-peer recovery without native file-operation marker evidence. `IF EXISTS`,
