...
detailed-counter proof path remains covered separately; short production
stats-off throughput samples remained noisy, so this is tracked as a bounded
hook/append overhead reduction rather than a broad throughput-completion claim.
...
builds. A reduced stats-off 5000-row,
