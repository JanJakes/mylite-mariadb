...
copy-style rebuild; row-format and other ALTER rebuild live recovery remains
planned.
...
Cross-schema and multi-pair rename, drop, rebuild, schema, view, trigger, and
foreign-key multi-DDL live-peer recovery remain partial/planned.
