...
and table-bearing `DROP DATABASE|SCHEMA` now have live-peer recovery for
...
also has marker-clear live recovery, and table-bearing
`DROP DATABASE|SCHEMA IF EXISTS` has marker-retaining live recovery.
