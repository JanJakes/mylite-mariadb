...
- Replacement-copy CTAS marker coverage, `FILE_MODIFY` marker coverage,
...
- Representative replacement-copy CTAS marker coverage is handled by the
  follow-up `ownerless-replacement-copy-file-op-marker-crash` slice.
