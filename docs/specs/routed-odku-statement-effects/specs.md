...
planned for trigger, view, offset/increment, integer-width, and other ODKU
expression paths. Grouped source-read rollback is covered separately in
`docs/specs/autoincrement-grouped-odku-source-read-errors/specs.md`, and
grouped source-driven update-expression rollback is covered separately in
...
- Triggers, views, and broader expression variants may have different
