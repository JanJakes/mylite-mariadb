...
- Parent-table truncate rejection, self-referencing FK truncate,
  generated-column/cyclic FK truncate shapes, partition truncate, and
  temporary-table truncate remain separate.
