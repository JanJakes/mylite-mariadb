...
4. Reconcile InnoDB redo with MyLite page-version visibility.
   ...
   a bounded 2 KiB / 4 KiB / 8 KiB compressed key-block matrix.
...
5. Add broad DDL compatibility tests.
   ...
   rollback, retry, and reopen behavior.
   ...
   execution and partial-child-row referential-action crash fuzzing remain
   planned.
