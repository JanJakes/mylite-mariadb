...
6. Extend the current bounded multi-object reader/writer stress into
   ...
   seed-sweep replay windows through seed `863`; the `16` through `31`,
   ...
   `768` through `799`, `800` through `831`, and `832` through `863`
   replays also cover FK graph seeds at rounds `2`. FK graph now
   participates in the
   dependency-free combined seed-sweep command-plan windows through seed `863`,
   ...
   `800` through `831`, and `832` through `863`
