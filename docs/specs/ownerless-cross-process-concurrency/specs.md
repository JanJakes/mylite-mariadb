...
6. Extend the current bounded multi-object reader/writer stress into
   ...
   seed-sweep replay windows through seed `1151`; the `16` through `31`,
   ...
   `1056` through `1087`, `1088` through `1119`, and `1120` through `1151`
   replays also cover FK graph seeds at rounds `2`. FK graph now
   participates in the
   dependency-free combined seed-sweep command-plan windows through seed `1151`,
   ...
   `1088` through `1119`, and `1120` through `1151`
