...
2. Keep page-version state available for rebuild/checkpoint evidence, but leave
   ...
   through 8192 row constructors reuse one page-log append session across the
   ...
   visible-fast inserts. The 8193-row boundary stays outside append batching
...
6. Extend the current bounded multi-object reader/writer stress into
   ...
   seed-sweep replay windows through seed `1087`; the `16` through `31`,
   ...
   `960` through `991`, `992` through `1023`, `1024` through `1055`, and
   `1056` through `1087`
   replays also cover FK graph seeds at rounds `2`. FK graph now
   participates in the
   dependency-free combined seed-sweep command-plan windows through seed `1087`,
   ...
   `992` through `1023`, `1024` through `1055`, and `1056` through `1087`
