...
6. Extend the current bounded multi-object reader/writer stress into
   ...
   seed-sweep replay windows through seed `1023`; the `16` through `31`,
   ...
   `960` through `991`, and `992` through `1023`
   replays also cover FK graph seeds at rounds `2`. FK graph now
   participates in the
   dependency-free combined seed-sweep command-plan windows through seed `1023`,
   ...
   `896` through `927`, `928` through `959`, `960` through `991`, and
   `992` through `1023`
