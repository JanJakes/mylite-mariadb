...
6. Extend the current bounded multi-object reader/writer stress into
   ...
   seed-sweep replay windows through seed `479`; the `16` through `31`,
   ...
   `352` through `383`, `384` through `415`, `416` through `447`, and `448`
   through `479`
   ...
   `383`, `384` through `415`, `416` through `447`, and `448` through `479`
