...
6. Extend the current bounded multi-object reader/writer stress into
   ...
   seed-sweep replay windows through seed `1311`; the `16` through `31`,
   ...
   `1248` through `1279`, and `1280` through `1311`
   replays also cover FK graph seeds at rounds `2`. FK
   graph now
   participates in the
   dependency-free combined seed-sweep command-plan windows through seed `1311`,
   ...
   `1184` through `1215`, `1216` through `1247`, `1248` through `1279`, and
   `1280` through `1311`
