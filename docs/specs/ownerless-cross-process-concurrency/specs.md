...
6. Extend the current bounded multi-object reader/writer stress into
   ...
   seed-sweep replay windows through seed `767`; the `16` through `31`,
   ...
   participates in the
   dependency-free combined seed-sweep command-plan windows through seed `639`,
   ...
   `703`, `704` through `735`, and `736` through `767`
