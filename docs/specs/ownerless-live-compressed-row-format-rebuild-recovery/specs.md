...
Update: `ownerless-live-compressed-key-block-rebuild-recovery` applies the same
live-peer recovery proof to key-block sizes `1`, `2`, `4`, and `16`.
...
- Key-block 1/2/4/16 live-recovery evidence is covered by
