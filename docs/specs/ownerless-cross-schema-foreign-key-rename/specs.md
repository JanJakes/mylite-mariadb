...
rename. It does not claim full cross-schema FK graph coverage, cross-schema FK
multi-rename, or crash-in-action recovery.
...
- This proves one cross-schema parent-table FK rename shape. Cross-schema FK
