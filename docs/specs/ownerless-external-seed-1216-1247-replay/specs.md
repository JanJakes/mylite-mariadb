# Ownerless External Seed 1216-1247 Replay
...
`1215`, and Docker-backed combined seed-sweep replay through seed `1215` for
...
`1216` through `1247`, and records Docker-backed MariaDB replay evidence for
...
- Replay windows from `224` through `1215` used
...
- Add a production CTest command-plan check for seeds `1216` through `1247` at
  two rounds across all three seeded suites.
- Run one dependency-free command-plan check for seeds `1216` through `1247`
  at two rounds with `--fk-graph-replay-attempts 10`.
- Record one Docker-backed MariaDB 11.8 seed-sweep replay for seeds `1216`
  through `1247` at two rounds with `--fk-graph-replay-attempts 10`.
...
- Run the direct `1216:1247` check-mode seed sweep at two rounds with
  `--fk-graph-replay-attempts 10`.
- Inspect Docker-backed `1216:1247` replay artifacts for manifest,
...
- Direct command-plan check passed for `1216:1247` at rounds `2` with
  `--fk-graph-replay-attempts 10`, ending with
  `ownerless_external_mariadb_seed_sweep_check=ok`.
- Docker-backed replay passed for `1216:1247` at rounds `2` with
  `--fk-graph-replay-attempts 10`, ending with
...
- Replay artifact inspection found `96` `expected.out` files, all exactly
  `ok`, and `96` empty `expected.err` files.
- FK graph retry inspection found transient raw MariaDB `1213` exits for seeds
  `1221`, `1223`, `1225`, `1228`, `1231`, `1232`, `1233`, and `1246`
  recovered on attempt `2`; seeds `1222`, `1234`, `1236`, and `1247`
  recovered on attempt `3`; and seed `1224` recovered on attempt `4`.
...
- Production CTest includes a dependency-free combined seed-sweep check for
  seeds `1216` through `1247` at two rounds.
- The direct check-mode command validates seeds `1216` through `1247` at two
...
- Docker-backed MariaDB 11.8 replay artifacts prove random transaction, DDL
  stress, and FK graph seeded suites for seeds `1216` through `1247` at two
  rounds.
