# Ownerless External Seed 1248-1279 Replay
...
`1247`, and Docker-backed combined seed-sweep replay through seed `1247` for
...
`1248` through `1279`, and records Docker-backed MariaDB replay evidence for
...
- Replay windows from `224` through `1247` used
...
- Add a production CTest command-plan check for seeds `1248` through `1279` at
  two rounds across all three seeded suites.
- Run one dependency-free command-plan check for seeds `1248` through `1279`
  at two rounds with `--fk-graph-replay-attempts 10`.
- Record one Docker-backed MariaDB 11.8 seed-sweep replay for seeds `1248`
  through `1279` at two rounds with `--fk-graph-replay-attempts 10`.
...
- Run the direct `1248:1279` check-mode seed sweep at two rounds with
  `--fk-graph-replay-attempts 10`.
- Inspect Docker-backed `1248:1279` replay artifacts for manifest,
...
- Direct command-plan check passed for `1248:1279` at rounds `2` with
  `--fk-graph-replay-attempts 10`, ending with
  `ownerless_external_mariadb_seed_sweep_check=ok`.
- Docker-backed replay passed for `1248:1279` at rounds `2` with
  `--fk-graph-replay-attempts 10`, ending with
...
- FK graph retry inspection found transient raw MariaDB `1213` exits for seeds
  `1249`, `1256`, `1262`, `1263`, `1267`, `1272`, and `1274` recovered on
  attempt `2`; seeds `1250` and `1278` recovered on attempt `3`; and seed
  `1270` recovered on attempt `4`.
...
- Production CTest includes a dependency-free combined seed-sweep check for
  seeds `1248` through `1279` at two rounds.
- The direct check-mode command validates seeds `1248` through `1279` at two
...
- Docker-backed MariaDB 11.8 replay artifacts prove random transaction, DDL
  stress, and FK graph seeded suites for seeds `1248` through `1279` at two
  rounds.
