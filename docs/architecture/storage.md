...
would be hidden. Eligible deletes from any
...
level-`1` branch has child capacity and no live overlay would be hidden.
...
fitting inserts, level-`3` lower-leaf splits, arbitrary child
