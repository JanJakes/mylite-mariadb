...
level-`5` sibling when that parent has child capacity; level-`6` parent-full
...
child capacity; level-`6` parent-full and broader recursive split cases remain
fallback behavior.
...
level-`6` root promotion, level-`6` level-five branch splits, arbitrary child
...
following row-state write. Broader
