...
| `routed-ddl-dml` | `storage-smoke-dev` | `compat-routed-ddl-dml` | Routed schema namespaces, table and index DDL, `CREATE TABLE ... LIKE`, `CREATE TABLE ... SELECT`, truncate, and DML smoke |
