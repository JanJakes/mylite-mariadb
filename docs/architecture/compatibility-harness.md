...
unsupported inventory currently records 4,139 upstream MTR files that are
...
InnoDB/MyISAM/FULLTEXT, funcs_1 native InnoDB/MyISAM metadata, external client
utilities, daemon utility binaries, or profile-specific result surfaces.
This
