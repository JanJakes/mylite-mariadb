...
| `transaction` | `storage-smoke-dev` | `compat-transaction` | Direct row-DML transaction commit/rollback, supported session autocommit mode, direct savepoint rollback/release, and unsupported transaction-control policy |
