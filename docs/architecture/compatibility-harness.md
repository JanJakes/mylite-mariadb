...
unsupported inventory currently records 2,841 upstream MTR files that are
...
Performance Schema, partition, Oracle SQL mode, Sequence, log-table, or
profile-specific result surfaces. This is a scale measurement, not
