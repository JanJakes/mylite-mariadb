...
unsupported inventory currently records 4,149 upstream MTR files that are
...
account/privilege behavior, external client utilities, daemon utility binaries,
or profile-specific result surfaces.
This
