...
unsupported inventory currently records 3,801 upstream MTR files that are
...
stress-runner, big-test, routine, trigger, view, processlist metadata, or
profile-specific result surfaces. This
