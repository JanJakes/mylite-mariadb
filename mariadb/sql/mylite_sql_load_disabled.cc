...
int mysql_load(THD *, const sql_exchange *, TABLE_LIST *, List<Item> &,
               List<Item> &, List<Item> &, enum enum_duplicates, bool, bool)
{
  my_error(ER_NOT_SUPPORTED_YET, MYF(0),
           "LOAD DATA/XML in the MyLite embedded profile");
  return true;
}
