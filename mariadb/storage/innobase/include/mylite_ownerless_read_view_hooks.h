...
extern std::atomic<bool> mylite_ownerless_read_view_hooks_enabled;

static inline int mylite_ownerless_read_view_hooks_enabled_fast(void)
{
    return mylite_ownerless_read_view_hooks_enabled.load(std::memory_order_relaxed) ? 1 : 0;
}
