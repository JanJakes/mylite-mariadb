...
OPTION(MYLITE_WITH_ZLIB_COMPRESSION "Build zlib-backed compression helpers" ON)

MACRO (MYSQL_CHECK_ZLIB_WITH_COMPRESS)

  IF(NOT MYLITE_WITH_ZLIB_COMPRESSION)
    SET(WITH_ZLIB "none" CACHE STRING
      "Which zlib to use (possible values are 'bundled', 'system', or 'none')" FORCE)
    SET(ZLIB_FOUND FALSE CACHE INTERNAL "Zlib disabled for MyLite profile" FORCE)
    SET(ZLIB_LIBRARIES "" CACHE INTERNAL "Zlib disabled for MyLite profile" FORCE)
    SET(ZLIB_INCLUDE_DIRS "" CACHE INTERNAL "Zlib disabled for MyLite profile" FORCE)
    SET(ZLIB_LIBRARY "" CACHE INTERNAL "Zlib disabled for MyLite profile" FORCE)
    SET(ZLIB_INCLUDE_DIR "" CACHE INTERNAL "Zlib disabled for MyLite profile" FORCE)
    SET(HAVE_COMPRESS 0 CACHE INTERNAL "Zlib compression disabled for MyLite profile" FORCE)
  ELSE()
